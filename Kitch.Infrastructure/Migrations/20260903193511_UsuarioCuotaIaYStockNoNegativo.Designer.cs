...
namespace Kitch.Infrastructure.Migrations
{
    ...
    [Migration("20260903193511_UsuarioCuotaIaYStockNoNegativo")]
    partial class UsuarioCuotaIaYStockNoNegativo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Kitch.Domain.Entities.StockUsuario", b =>
                {
                    ...
                    b.ToTable("StockUsuario", null, t =>
                        {
                            t.HasCheckConstraint("CK_StockUsuario_CantidadNoNegativa", "[Cantidad] >= 0");
                        });
                });
            ...
            modelBuilder.Entity("Kitch.Domain.Entities.Usuario", b =>
                {
                    ...
                    b.Property<DateTime?>("FechaCuotaIaUtc")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<int>("PeticionesIaDelDia")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);

                    b.Property<string>("PreferenciaDietetica")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                    ...
                    b.Property<string>("UltimaRecetaIaJson")
